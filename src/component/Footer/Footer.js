...
function Footer() {
  return (
     ...
     <div className="footer-container">
      <div className="footer-bottom">
        ...
        <div className="footer-bottom-connect">
          ...
          <Link to="/">
            <img className="connect-ions" src={facebook} width="20px" height="20px" alt="myntra" />
          </Link>
          <Link to="/">
            <img className="connect-ions" src={twitter} width="20px" height="20px" alt="twitter"/>
          </Link>
          <Link to="/">
            <img className="connect-ions" src={instagram} width="20px" height="20px" alt="instagram"/>
          </Link>
        </div>

        <div className="footer-bottom-return">
          <div className="footer-section">
            <div className="footer-images"> <img src={originaal} alt="footer" width="40px"/></div>
          <div className="footer-promises"><strong>100 % ORIGINAL </strong> 
          guarantee<br/> for all products at Hair-Heaven</div>
        </div>

          <div className="footer-sectiontwo">
            <div className="footer-images"><img src={arrow} alt="footer" width="40px"/></div>
            <div className="footer-return"><strong>Return within 30 days</strong><br/> of receiving your products</div>
          </div>
          </div> 
        </div>
      </div>
    ...
    <div className="footer-owner">
      Made in India by Shruti Gawande
    </div>
    </div>
  )
}
